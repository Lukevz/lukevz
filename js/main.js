// ── Markdown → HTML (for case study bodies from Bear) ──
    ...
    // ── Gear ──
    const GEAR = [
      // pngimg.com = confirmed transparent PNGs; Apple CDN = product select images (load in browser)
      { name: 'BenQ MA270S',           detail: '27" 5K Monitor',            img: 'https://pngimg.com/uploads/monitor/monitor_PNG101655.png' },
      { name: 'MacBook Pro 14"',        detail: 'M3 Pro · Space Black',      img: 'https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/mbp14-spblk-select-202310?wid=904&hei=840&fmt=jpeg&qlt=95' },
      { name: 'Fujifilm X-S20',         detail: 'Mirrorless Camera',         img: 'https://pngimg.com/uploads/photo_camera/photo_camera_PNG101600.png' },
      { name: 'XF 18–55mm f/2.8–4',    detail: 'Fujifilm Lens',             img: 'https://pngimg.com/uploads/camera_lens/camera_lens_PNG102224.png' },
      { name: 'XF 70–300mm f/4.5–5.6', detail: 'Fujifilm Lens',             img: 'https://pngimg.com/uploads/camera_lens/camera_lens_PNG79112.png' },
      { name: 'Shure MV7',              detail: 'USB Microphone',            img: 'https://pngimg.com/uploads/microphone/microphone_PNG101686.png' },
      { name: 'Bose QC Ultra',          detail: 'Headphones · Lunar Blue',   img: 'https://pngimg.com/uploads/headphones/headphones_PNG101924.png' },
      { name: 'MX Master 4',            detail: 'Wireless Mouse',            img: 'https://pngimg.com/uploads/computer_mouse/computer_mouse_PNG7694.png' },
      ...
      { name: 'iPhone 17 Pro',          detail: 'White Titanium',            img: 'https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone17-pro-finish-select-202509-whitetitanium?wid=940&hei=1112&fmt=jpeg&qlt=95' },
      { name: 'Kindle Paperwhite',      detail: 'E-Reader',                  img: 'https://pngimg.com/uploads/tablet/tablet_PNG8590.png' },
      { name: 'Sonos Beam',             detail: 'Gen 2 · Soundbar',          img: 'https://pngimg.com/uploads/wireless_speaker/wireless_speaker_PNG17.png' },
      { name: 'Dreame H12 Pro',         detail: 'Wet & Dry Vacuum',          img: 'https://pngimg.com/uploads/vacuum_cleaner/vacuum_cleaner_PNG57.png' },
      { name: 'Philips Wake-Up Light',  detail: 'HF3520',                    img: 'https://pngimg.com/uploads/alarm_clock/alarm_clock_PNG57.png' },
    ];
